...
namespace ValorantCC_Custom_WPF
{
    public partial class MainWindow : Window
    {
        ...
        private string _crosshair = "Circle"; // cricle / plus
        private int _crosshairSize = 10;
        private System.Windows.Media.SolidColorBrush _crosshairColor = System.Windows.Media.Brushes.Red;
        private string _crosshairColorString = "Red";
        ...
        private void DrawPlus()
        {
            ...
            canvas.Children.Clear();
            double thickness = Math.Max(_crosshairSize / 10, 1);
